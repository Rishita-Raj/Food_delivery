...
const PaymentSuccess = () => {
  ...
  return ( 
  <div className="flex min-h-[70vh] items-center justify-between px-4 ">
    <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-sm text-center space-y-4">
        ...
        <div className="space-y-2 pt-2">
            <button className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#e23744] py-2 text-sm font-semibold text-white" onClick={()=> navigate("/")}>
                Order More <BsArrowRight size={16} />
            </button>
            <button className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#e23744] py-2 text-sm font-semibold text-white" onClick={()=> navigate("/orders")}>
