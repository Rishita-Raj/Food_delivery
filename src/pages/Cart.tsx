...
const Cart = () => {
  ...
  return  <div className="mx-auto max-w-5xl px-4 py-6 space-y-6">
    ...
    <div className="rounded-xl bg-white p-4 shadow-sm space-y-3">
      ...
      <button onClick={checkout} className={`mt-3 w-full rounded-lg bg-[#E23744] py-3 text-sm font-semibold text-white hover:bg-rose-800 ${!restaurant.isOpen ? "opacity-50 cursor-not-allowed" : ""}`}
