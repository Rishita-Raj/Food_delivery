    ...
    <div className="mx-auto max-w-xl rounded-xl bg-white shadow-sm overflow-hidden">
      {
        ...
        alt=""  className="h-48 w-full object-cover"
        />
      )}
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-center justify-between pt-3 border-t">
            ...
            <div className="flex gap-3">
                ...
                {
                    isSeller && (<button onClick={toggleOpenStatus} className={`rounded-lg px-4 py-1.5 text-sm font-medium text-white ${
        ...
        <p className="text-xs text-gray-400">
            Created on {new Date(restaurant.createdAt).toLocaleDateString()}</p>
      </div>
    </div>
  )
}
